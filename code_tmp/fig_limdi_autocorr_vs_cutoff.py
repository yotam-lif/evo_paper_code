...
TableS1_limdi_autocorr.py keeps a gene pair only where both sides exceed NONLETHAL_CUT = -0.3, then
...
autocorrelation.  Conventions otherwise match TableS1_limdi_autocorr.py exactly (genes matched on
...
ANALYSIS_CUT = -0.3                                  # the cut TableS1_limdi_autocorr.py uses
