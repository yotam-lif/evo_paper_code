...
last axis of ``fitness_corrected_genes.npy``.  The main analysis (TableS1_autocorr.py,
...
TableS1_autocorr.py, so the evolved-panel r values reproduce that table.
"""
import os
import sys
...
def clone_pair(early, late, errors=False):
    ...
    This is what TableS1_autocorr.py and fig1_limdi_clones.py use, so its r reproduces the
