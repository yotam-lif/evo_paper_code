r"""Fisher's Geometric Model DFE fit to ancestor genotypes -> figS7_exper_bayes.pdf.
...
Outputs:
    figs_paper/figS11_exper_bayes.pdf           per-clone data + moment-locked FGM fit (the figure)
    figs_paper/figS11_sigma_loglik_profile.pdf  per-clone sigma likelihood profile (bimodality check)
...
Run from anywhere:  python code_figs/figS11_fgm_exper.py
"""
import json
import os
import sys
...
FIG_PATH = os.path.join(FIGS, "figS11_exper_bayes.pdf")
FIG_PROFILE_PATH = os.path.join(FIGS, "figS11_sigma_loglik_profile.pdf")
...
# ══════════════════════════════════════════════════════════════════════════════
# Figure: per-clone data histogram + moment-locked FGM fit (figS7_exper_bayes.pdf)
...
def write_sigma_profile_txt(results, order, path):
    ...
    out = [
        ...
        "Generated by code_figs/figS11_fgm_exper.py",
        "",
