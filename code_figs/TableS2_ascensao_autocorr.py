...
the experimental correlation.
    ...
    data/TableS2_ascensao_autocorr.csv
...
Requires the cache built by ``data/asencao_dfe_arrays/build_monoculture_from_repo.py``.

Run:
    python code_figs/TableS2_ascensao_autocorr.py
"""
import argparse
import csv
import hashlib
...
OUT_CSV = os.path.join(DATA_DIR, "TableS2_ascensao_autocorr.csv")
...
# ladder.  Same rule and same fractions as TableS1_couce_autocorr.py, so the two tables are read the
